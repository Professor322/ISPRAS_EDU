...
/*** From source: knight_problem_v2.pml ***/
...
short src_ln0 [] = {
	  0,  41,  42,  43,  44,  45,  40,  39, 
	 54,  41,  42,  43,  44,  45,  40,  39, 
	 55,  41,  42,  43,  44,  45,  40,  39, 
	 56,  41,  42,  43,  44,  45,  40,  39, 
	 57,  41,  42,  43,  44,  45,  40,  39, 
	 58,  41,  42,  43,  44,  45,  40,  39, 
	 59,  41,  42,  43,  44,  45,  40,  39, 
	 60,  41,  42,  43,  44,  45,  40,  39, 
	 61,  41,  42,  43,  44,  45,  40,  39, 
	 53,  63,  53,  63,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "knight_problem_v2.pml", 1, 75 },
	{ "-", 76, 77 }
};
uchar reached0 [] = {
	  0,   1,   0,   0,   0,   0,   1,   0, 
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		for (l_in = 0; l_in < 25; l_in++)
		{
			logval("field[l_in]", now.field[l_in]);
		}
	}
...
{	/* int i; */
	...
	{	int l_in;
		for (l_in = 0; l_in < 25; l_in++)
		{
			printf("	bit    field[%d]:	%d\n", l_in, now.field[l_in]);
		}
	}
	printf("	int    step_count:	%d\n", now.step_count);
	printf("	int    cur_i:	%d\n", now.cur_i);
	printf("	int    cur_j:	%d\n", now.cur_j);
}
void
