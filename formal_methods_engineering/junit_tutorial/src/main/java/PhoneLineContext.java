...
//
    ...
    //
        ...
        static
        {
            Ready = new PhoneLineFSM_Default.PhoneLineFSM_Ready("PhoneLineFSM.Ready", 0);
            Conversation = new PhoneLineFSM_Default.PhoneLineFSM_Conversation("PhoneLineFSM.Conversation", 1);
            Warning = new PhoneLineFSM_Default.PhoneLineFSM_Warning("PhoneLineFSM.Warning", 2);
            Idle = new PhoneLineFSM_Default.PhoneLineFSM_Idle("PhoneLineFSM.Idle", 3);
